...
/**
 * WeChat Pay parameters with all necesary data to perform a transaction.
 * @param shopperIdentifier the shopper's account identifier (identity code)
 * @param source the source of the identifier
 * @since 2.34.0
 */
+ (nullable instancetype)weChatPayParametersWithShopperIdentifier:(nonnull NSString*)shopperIdentifier source:(MPPaymentDetailsSource)source;

...
typedef NS_OPTIONS(NSUInteger, MPPaymentAccessoryRequirement) {
    ...
    /** Indicates that the accessory does not need to display present card screen for NFC transactions */
    MPPaymentAccessoryRequirementNoNfcStartDisplay              = 1 << 4,
    
    /** Skippable MOTO fields are skipped using the abort button */
    MPPaymentAccessoryRequirementMotoAbortSkipsEntry            = 1 << 5
};

...
typedef NS_ENUM(NSUInteger, MPAccessoryType){
    ...
    /** Ingenico Lane3000 */
    MPAccessoryTypeIngenicoLane3000,
    /** Ingenico Lane5000 */
...
/**
 * An accessory contains all information related to a specific accessory connection. The connection can be established by multiple channels (e.g. WiFi, Blueooth, Dock-Connector).
 * @since 2.0.0
 */
